defmodule ArtsyNeighborWeb.UserAuth do
  ...
  @remember_me_cookie "_artsy_neighbor_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ArtsyNeighborWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      ArtsyNeighborWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule ArtsyNeighborWeb.PageLive do
        use ArtsyNeighborWeb, :live_view

        on_mount {ArtsyNeighborWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{ArtsyNeighborWeb.UserAuth, :require_authenticated}] do
