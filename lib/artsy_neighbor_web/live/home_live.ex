  ...
  def render(assigns) do
    ...
    >
      <div class="grid grid-cols-1 gap-8">
        ...
        <section class="hero">
          <div
            style={"background-image: url(#{~p"/images/artist-hero.jpg"})"}
            class="mt-8 w-full h-96 bg-cover bg-center rounded-lg"
          >
          </div>
        ...
        <section>
          ...
          >
            <.product_card
              :for={{dom_id, product} <- @streams.featured_products}
              product={product}
              dom_id={dom_id}
            />
          </div>
        ...
        <section>
          ...
          >
            <.product_card
              :for={{dom_id, product} <- @streams.favorite_products}
              product={product}
              dom_id={dom_id}
            />
          </div>
