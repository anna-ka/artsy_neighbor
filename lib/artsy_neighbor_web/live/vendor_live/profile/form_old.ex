defmodule ArtsyNeighborWeb.VendorLive.Profile.OldForm do
        ...
        <.form for={@form} id="artist_form" phx-submit="save" phx-change="validate">
          <div>
            <p class="text-sm text-base-content/70">
              Note: only the fields marked "Visible to customers" are shown on your public profile. Your address (except the area code), phone and email are not visible to customers.
