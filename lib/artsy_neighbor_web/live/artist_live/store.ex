defmodule ArtsyNeighborWeb.ArtistLive.Store do
  ...
  def handle_params(%{"id" => id} = params, _uri, socket) do
    ...
    case Artists.get_artist(id) do
      ...
      artist ->
        categories =
          ArtsyNeighbor.Categories.list_categories() |> Enum.map(fn cat -> {cat.name, cat.id} end)

        collections =
          Products.list_collections_for_artist_no_preloads(artist.id)
              ...
              <div class="lg:col-span-2">
                ...
                <div :if={nil} class="flex flex-col items-center gap-3 mb-8">
                  ...
                  <.button_artsy
                    ...
                    variant="secondary"
                    size="wide"
                    navigate={~p"/artists/#{@artist}/store"}
                  >
                    View Shop
                  </.button_artsy>
                </div>
      ...
      <div class="flex flex-wrap gap-4 items-end">
        ...
        <div class="min-w-48">
          <.input
            ...
            type="select"
            label="Collection"
            prompt="All collections by artist"
            options={@collections}
          />
        </div>
